...
public class GmkApi {
    public static JSONObject callGmkApi(String strUrl, String method, String authorization, JSONObject requestJson){
    ...
    public static JSONArray callGmkArrApi(String strUrl, String method, String authorization, JSONObject requestJson){
        LogWriter logWriter = new LogWriter(method, strUrl, System.currentTimeMillis());
        Gson gson = new GsonBuilder().setPrettyPrinting().create();
