...
*/
    ...
    String insertStock(String strRatePlanId, String strRoomTypeId, String propertyId, String strDate, int intStock, int intBasicPrice, int intSalePrice, int intOMKPrice);
